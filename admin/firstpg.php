...
<html lang="en">
	...
	<body>
		<div class="login">
			<form class="login-container validate-form" name="login-form" method="POST" action="firstpg.php">
				...
				<?php
					...
					if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['signin-button']))
					{
						...
						if($count > 0)
						{
							...
							$_SESSION['username_aerobook_rental'] = $username;
							$_SESSION['password_aerobook_rental'] = $password;
							$_SESSION['user_id_aerobook_rental'] = $row['user_id'];
							header('Location: dashboard.php');
							die();
						}
						else
